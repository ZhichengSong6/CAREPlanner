...
echo "[C5.7] COMMIT GATE: exact executable prefix+brake+hold must pass final GCDF, then exact VBC"
echo "[C5.7] PROBE success: count only tracker complete=1 with matching committed seq"
