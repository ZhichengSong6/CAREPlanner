...
REGION_SCHEDULE_MODE="${REGION_SCHEDULE_MODE:-blocker_aware_acquisition}" \
...
cycle_recovery_prefix_ladder=${REPAIR_PREFIX_S}->0.15->0.10->0.05
cycle_recovery_safety=each_prefix_final_gcdf_then_exact_vbc
